...
if(isset($_REQUEST['submit1']))
{
    ...
    $sql = "INSERT INTO Employees(Name, Type, amount)
    VALUES('".$_REQUEST['e_name']."', '".$_REQUEST['type']."', '".$_REQUEST['amount']."');"; //PAymentID auto increments
    $table = "Employees"; //Spec used for this proj
...
Employee name: <input type="text" name="e_name"><font color=red>* <?php echo $employe_name_error_msg ?></font><br><br>
Payment type: 
<select name="type">
...
Payment amount <input type="text" name="amount" maxlength=6> <font color=red>(max 999999) <?php echo $payment_amount_error_msg ?></font>
<br><br>
...
<tr><td align=right><input type=radio name="sortby" value="bynoway" checked  ></td><td>Display information in its orignal way</td></tr>
...
if($_REQUEST['submit2'] )
{
    ...
    {
        case 'bynoway': displayEverything(); break;
        case 'byname': sortByNameASC(); break;
        case 'byone': findSalryByName($_REQUEST['name']); break;
        case 'bytotal': sortByTotal(); break;
        case 'bytype': sortByType($_REQUEST['type']); break;
        case 'bymax': highestBonus(); break;
        case 'bycat': totalPaymentByCatagory(); break;
